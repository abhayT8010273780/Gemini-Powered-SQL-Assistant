...
genai.configure(api_key='AIzaSyDIsIw5HuHSpT39xmCh2QERN8Pey-JLWh0')  # Replace with your actual API key
...
- Target database: Naresh_it_employee2.
- Table: Naresh_it_employee2.
...
A: SELECT COUNT(*) FROM Naresh_it_employee2

Q: Show all Data Engineers
A: SELECT * FROM Naresh_it_employee2 WHERE employee_role = 'Data Engineer'

Q: Who earns more than 60000?
A: SELECT * FROM Naresh_it_employee2 WHERE employee_salary > 60000

Q: Who earns the highest salary?
A: SELECT * FROM Naresh_it_employee2 ORDER BY employee_salary DESC LIMIT 1
...
if st.button("Run"):
    if question.strip() == "":
        ...
        # Run SQL query
        result, columns = read_sql_query(sql_query, "Naresh_it_employee2.db")
